...
export default{
    ...
    methods:{
        mylogin(){
            var that=this;
            $.ajax({
                url:this.staticURL+'users/myadmin',
                data:{
...
@media (min-width: 768px){
    ...
    .lg{width:468px; height:468px; margin:0 auto; background:url('http://shenyuxf.top/blog/static/img/login_b1g.0ce2d7e.png') no-repeat;}
