...
<script type="text/javascript">
    ...
    export default{
        ...
        created(){
            ...
            axios.get('http://localhost:3000/searchKeyword',{params:{keyword:this.$route.params.keyword}}).then((data)=>{
               // console.log(data.data)
                this.articles=data.data
            },(err)=>{
                this.message='请求失败'
            })
            axios.get('http://localhost:3000/searchKeywordAcount',{params:{keyword:this.$route.params.keyword}}).then((data)=>{
                //console.log('333',data.data.length)
        ...
        methods:{
            ...
            handleClick (newIndex){
                ...
                axios.get(`http://localhost:3000/searchKeyword/?page=${newIndex}`,{params:{keyword:this.$route.params.keyword}}).then((data)=>{
                    console.log(data.data)
                    this.articles=data.data
                },(err)=>{
                    this.message='请求失败'
