...
<script type="text/javascript">
    ...
    export default{
        ...
        created(){
            ...
            axios.get('http://localhost:3000/articleType',{params:{type:this.$route.query.type}}).then((data)=>{
            ...
            //总条数
            axios.get('http://localhost:3000/typeCount',{params:{type:this.$route.query.type}}).then((data)=>{
        ...
        methods:{
            ...
            handleClick (newIndex){
               // console.log('--------',newIndex)
                axios.get(`http://localhost:3000/articleType/?page=${newIndex}`,{params:{type:this.$route.query.type}}).then((data)=>{
                //console.log(data.data)
                    this.articles=data.data
                },(err)=>{
                    this.message='请求失败'
