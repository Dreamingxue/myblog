                ...
                <div class="row">
                    ...
                    <aside class="col-xs-12 col-sm-12 col-md-4 sidebar">
                        ...
                        <div class="widget">
                            ...
                            <div class="content community">
                                <form id="search" role="search">
                                    ...
                                    <input type="text" name="s" class="text asearch" placeholder="输入关键字搜索" v-model='keyword' @keyup.13='searchKeyword'>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="widget">
                            ...
                            <div class="content">
                                <iframe width="100%" height="550" class="share_self"  frameborder="0" scrolling="no" src="http://widget.weibo.com/weiboshow/index.php?language=&width=0&height=550&fansRow=2&ptype=1&speed=0&skin=1&isTitle=1&noborder=1&isWeibo=1&isFans=1&uid=5753729518&verifier=fd7965e4&dpc=1"></iframe>
                            </div>
                        </div>
                        <!-- end widget -->
                    </aside>
                        ...
                        <div class="widget">
                            ...
                            <div class="content recent-post">
                                <div class="recent-single-post" v-for='currentArticle in currentArticles'>
                                    <a :href="'#/current/'+currentArticle.type+'/number='+currentArticle.id+'?id='+currentArticle._id" class="post-title" v-html='currentArticle.title'>
                                   </a>
                        ...
                        <div class="widget">
                            ...
                            <div class="content recent-post">
                                <div class="recent-single-post">
                                    <a href='#/index/contactAuthod' class="post-title">联系作者</a>
                                </div>
                                <div class="recent-single-post">
                                    <a href="#index/aboutUs" class="post-title">关于我们</a>
                                </div>
                                <div class="recent-single-post">
...
<script type="text/javascript">
    ...
    export default{
        ...
        created(){
            //请求所有文章数据
            axios.get('http://localhost:3000/currentArticle').then((data)=>{
            ...
            //请求所有标签数据
            axios.get('http://localhost:3000/findTags').then((data)=>{
                if(data.data.code=1){
...
<!-- ['MaxOS','ie兼容','JavaScript','Brew','ECMA6','微信','小程序','回调地域','promise','Linux','Mongo','node.JS','读后感','npm','mardown','编辑器','模块化','cmd','babel','前端','优化','api','总结','sublime','bind-addres','包管理工具','windows','数据库','ie6','其他','table','布局','程序员','meda','viewport','console','调试'] -->